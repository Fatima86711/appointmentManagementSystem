...
const MyProfile = () => {
  ...
  // Guard: if userData not loaded, show loading message
  if (!userData) return <p className='text-gray-500'>Loading profile...</p>;
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm' > 
      ...
      {/* <hr /> */}
      <div className='bg-zinc-400 h-[1px] mb-5 border-none' >
