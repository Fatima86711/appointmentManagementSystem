...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center gap-4 my-16 text-gray-900 md:mx-10 '  >
        <h1 className='text-3xl font-medium'  >Top to Doctors to Book</h1>
        ...
        <button onClick={()=>{navigate('/doctors');  scrollTo(0,0)}} className='bg-blue-50 text-gray-600 px-12 py-3 cursor-pointer hover:bg-blue-100 rounded-full mt-10 '> More</button>
    </div>
  )
}
